...
namespace GymMs.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
		...
		public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // if role list is empty roel = customer 
        ...
        private ApplicationUserM CreateUser()
        {
            try
            {
                return Activator.CreateInstance<ApplicationUserM>();
            }
            catch
            {
